...
namespace DataAccessLayer.Concrete
{
    public class Context : IdentityDbContext<AppUser, AppRole, int>
    {
        ...
        {//Yukarıdaki metod bir syntax. OnConfiguring olarak yazılmalı.
            optionsBuilder.UseSqlServer("server=(localdb)\\MSSQLLocalDB;database=TraversalDB;integrated security = true");
            //MsSql'de TraversalDB adında database oluşturup bunu kod ile bağlantılı hale getirdik.
        }
        //DbSet içerisinde EntityLayer'daki Concrete klasöründe tanımladığımız Class'ları(Tablolar) tanımlıyoruz.
